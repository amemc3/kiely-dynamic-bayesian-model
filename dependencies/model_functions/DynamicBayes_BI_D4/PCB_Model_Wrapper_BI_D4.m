%% PCB_Model_Wrapper_BI_D4
% this is the wrapper function which runs the 
% dynamic bayesian model (BI_D4) for a given task

function PCB_Model_Wrapper_BI_D4(data_folder, root_folder, day, group, task)
...
for agent=1:n_subjects
    ...
    funcName = ['PCB_fmin_function_', task, '_BI_D4'];
...
cd(root_folder)
filename = [day '_' task '_BI_D4_' group '.mat'];
