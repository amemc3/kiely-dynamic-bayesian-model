...
function PCB_Simulation_Wrapper_BI_D4(finalFolder, realData, task)
...
for iS = 1:NS
    ...
    funcName = ['PCB_simulation_', task, '_BI_D4'];
    ...
    elseif strcmp(task,'3slot')
        cond = {[3,5,9,1,2,4,10,7,8,6]; pars};
    end
