%% PCB_simulation_probs_3fish_BI_D4

% Generate a .mat file in the same format as the real subjects
% but store choice probabilities rather than simulated choice

function simData = PCB_simulation_probs_3fish_BI_D4(pars)
