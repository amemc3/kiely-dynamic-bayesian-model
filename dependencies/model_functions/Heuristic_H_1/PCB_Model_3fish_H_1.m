%% PCB_Model_3Fish_H_1
% Adapted from PCB_Model_3fish_BI_1 and fiore heuristic
% This script runs a heuristic model on the 3 fish task.
% It generates a .mat file (3fish_H_1_group.mat) containing the 
...
function PCB_Model_3fish_H_1(data_folder, root_folder, day, group)
...
cd (root_folder)
filename = [day '_3fish_H_1_' group '.mat'];
