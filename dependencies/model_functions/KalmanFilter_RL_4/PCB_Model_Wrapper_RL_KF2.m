%% PCB_Model_Wrapper_RL_KF2
% this is the wrapper function which runs the 
% kalman filter RL model (RL_KF2) for a given task

function PCB_Model_Wrapper_RL_KF2(data_folder, root_folder, day, group, task)
...
for agent=1:n_subjects
    ...
    funcName = ['PCB_fmin_function_', task, '_RL_KF2'];
...
cd(root_folder)
filename = [day '_' task '_RL_KF2_' group '.mat'];
