%% PCB_Model_Wrapper_BI_1
% this is the wrapper function which runs the 
% standard bayesian model (BI_1) for a given task

function PCB_Model_Wrapper_BI_1(data_folder, root_folder, day, group, task)
...
for agent=1:n_subjects
    ...
    funcName = ['PCB_fmin_function_', task, '_BI_1'];
...
cd(root_folder)
filename = [day '_' task '_BI_1_' group '.mat'];
